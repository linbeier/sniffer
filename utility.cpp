...
int utility::analyze_frame(const u_char *pkt, datapkt *data, pktCount *npacket)
{
...
//对链路层协议的上一层协议继续进行分析
int utility::analyze_arp(const u_char *pkt, datapkt *data, pktCount *npacket)
{
...
/*分析网络层：IP*/
int utility::analyze_ip(const u_char* pkt,datapkt *data, pktCount *npacket)
{
...
int utility::analyze_icmp(const u_char *pkt, datapkt *data, pktCount *npacket)
{
...
int utility::analyze_tcp(const u_char *pkt, datapkt *data, pktCount *npacket)
{
...
int utility::analyze_udp(const u_char *pkt, datapkt *data, pktCount *npacket)
{
